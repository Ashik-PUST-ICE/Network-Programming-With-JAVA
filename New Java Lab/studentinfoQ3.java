...
public class studentinfoQ3 implements ActionListener {
...
panel.add(userText2);
JTextField userText3 = new JTextField("Enter Your dept name");
userText3.setBounds(100,110,200,25);
panel.add(userText3);
button = new JButton("Save");
button.setBounds(150, 160, 80, 25);
button.addActionListener(new studentinfoQ3());
panel.add(button);
success = new JLabel("");
